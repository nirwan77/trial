      ...
      <div className="flex flex-col items-center mx-4 rounded-3xl bg-green-900">
        ...
        >
          <div className="relative">
            <div onClick={() => router.push("/ccts/viewpost")}>
              <Image
                priority={true}
                src={"/pending.svg"}
                width={400}
            ...
            <div className="absolute w-full bottom-0 filter backdrop-blur-md  rounded-b-3xl bg-gradient-to-b from-transparent via-transparent to-black bg">
            ...
            <div className="shadow mb-4 w-full relative inline-flex rounded-2xl cursor-pointer select-none items-center font-bold text-sm bg-SoSHColorDisabled">
              <div
                className={`flex items-center justify-center w-1/2 rounded-2xl py-3 w-60% text-sm font-bold ${
                  option === "Buy" ? "text-primary bg-white" : "text-body-color"
                }`}
