  ...
  return (
    <div className="h-full flex justify-start flex-col items-center">
      <div className="mb-8 mt-10 font-[425]">
        ...
        <h2 className="font-black leading-Sosh22">Purchase CCT asset</h2>
      </div>
      ...
      <div className="mb-4 flex flex-col items-center w-80 px-7">
        <div className="text-SoshColorGreyScale font-black text-2xl leading-Sosh22 mb-4">
          Success
        </div>
        <div className="text-SoshColorGreyScale text-sm font-normal leading-5 text-center">
